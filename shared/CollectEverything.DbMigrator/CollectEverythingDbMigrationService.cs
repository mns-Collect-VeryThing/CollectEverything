...
public class CollectEverythingDbMigrationService : ITransientDependency
{
    private readonly ICurrentTenant _currentTenant;
    private readonly IDataSeeder _dataSeeder;
    private readonly ILogger<CollectEverythingDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public CollectEverythingDbMigrationService(
        ILogger<CollectEverythingDbMigrationService> logger,
